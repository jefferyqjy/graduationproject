...
<div id="wrap">
    ...
    <div id="content-wrap">
        ...
        <div class="btn"><input name="" type="button" class="login-btn" value=""/></div>
        <div id="message-box"> 用户名或密码错误！ </div>
      </div></form>
    </div>
    <br/><br/>
    <form action="<%=basePath %>/admin/admin_reg.do" id="regForm" method="post" name="regForm">
    <!-- 
    <div align="center"> <img src="<%=basePath %>/sys_css/reg.gif" alt="注册" onclick="reg()" style="cursor:hand;"/> </div>
     -->
    </form>
