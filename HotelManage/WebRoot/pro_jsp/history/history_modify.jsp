...
<html>
		...
		<body id="page">
			...
			<div class="pageInput">
			<form action="history/history_update.do" method="post" name="mainform" target="history_window">
				<table>
				<input type='hidden' name='id' value='${result.id }' />
					...
					<tr>
						<td>totalprice</td>
						<td>
							<input type="text" name="totalprice" value="${result.totalprice }" />
						</td>
						<td><span id="totalprice_errMsg"></span></td>
					</tr>
					<tr>
						<td colspan="3">
