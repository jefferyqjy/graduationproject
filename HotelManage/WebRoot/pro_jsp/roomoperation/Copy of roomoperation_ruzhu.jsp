...
<html>
			...
			<script type="text/javascript">
				...
				function checkAndSubmit2(custgenid) {
					...
					if(formValidation(true)){
					 	...
					 	var ee =  $('endtime').val();
						var url = "roomoperation/roomoperation_searchfreeroom.do?custgenid="+custgenid+"&begintime="+bb+"&endtime="+ee;
		...
		<body id="page">
			...
			<div class="pageTitle">当前位置：客户入住</div>
				...
				<table>
					...
					<tr>
					 ...
					 <tr>
						<td>客户姓名：</td>
						<td>
							${result.custid }:${record.customergenerateid }
						</td>
						<td><span id="custid_errMsg"></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<input type="text" readonly="readonly" name="begintime" id="begintime" value="${result.begintime }" onfocus="calendar.show(this)" class ="DATE_M" >
						</td>
					...
					<tr>
						...
						<td>
							...
							<input type="text" readonly="readonly" name="endtime" id="endtime" value="${result.endtime }" onfocus="calendar.show(this)" class ="DATE_M" >
						</td>
					...
					<tr>
						...
						<td>
							...
							<img title="查找" src="<%=basePath%>/sys_css/icon/edit2.png" width="16" height="16" onclick="mdy('<%=basePath%>/roomoperation/roomoperation_searchfreeroom.do?custgenid=${record.custgenid}')"/>
							 -->
							<input type="button" class="bt" value="查找房间" onClick="checkAndSubmit2('${record.custgenid}')" />
						</td>
