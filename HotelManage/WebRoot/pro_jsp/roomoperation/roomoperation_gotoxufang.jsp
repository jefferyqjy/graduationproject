...
<html>
		...
		<body id="page">
			...
			<div class="pageTitle">当前位置：客户续房</div>
			<div class="pageInput" align="center">
			<form action="roomoperation/roomoperation_xufang.do" method="post" name="mainform" target="roomoperation_window">
				...
				<table>
					...
					<tr>
						<td colspan="3">
							<input type="button" class="bt" value="续房" onClick="checkAndSubmit()" />
						</td>
					</tr>
				</table>
			</form>
