...
<html>
		...
		<body id="page">
			...
			<div class="pageTitle">当前位置：客人调房</div>
			<div class="pageInput" align="center">
			<form action="roomoperation/roomoperation_tiaofang.do" method="post" name="mainform" target="roomoperation_window">
				...
				<table>
					...
					<tr>
						<td colspan="3">
							<input type="button" class="bt" value="调房" onClick="checkAndSubmit()" />
						</td>
					</tr>
				</table>
			</form>
