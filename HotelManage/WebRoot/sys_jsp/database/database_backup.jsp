		...
		<body>
			...
			<div class="content-box-header">
				...
				<ul class="content-box-tabs">
					<li><a href="#tab1" class="default-tab">数据库备份</a></li>
				</ul>
				<div class="clear"></div>
			</div>
			...
			<jsp:include page="/sys_jsp/notification.jsp"></jsp:include>
				<div class="tab-content default-tab" id="tab1">
					<form action="<%=basePath %>database/database_backup.do" method="post" name="mainform">
					<fieldset>
					<p>
						<b>数据库类型:</b>
						<select name="type">
					...
					<p>
						<b>数据库名称:</b>
						<input class="text-input small-input" type="text" id="name" name="name" rule="CHAR_M_120"/>
