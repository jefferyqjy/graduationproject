...
public class SftpTransmit implements Transmit 
{
	...
	public SftpTransmit(String ip,String username)
	{
...
//		this.sftp.put(in,serverDestFile);//here is blocking 
	...
	*/	
	...
	/**
	 * this API have below  function
	 * 1.rename file  			sample  renameMoveFile("/aa.txt", "/bb.txt") 
	 * 2.move file  	 		sample  renameMoveFile("/aa.txt", "/testDir/aa.txt") 
	 * 3.rename and move file 	sample  renameMoveFile("/aa.txt", "/testDir/bb.txt") 
	 */
