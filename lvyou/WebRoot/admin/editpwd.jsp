...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	%><body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr valign="top">
				<td bgcolor="#FFFFFF">
					<s:form action="users/editpwd.action" name="myform"
						...
						<table width="40%" border="0" align="center" cellpadding="4"
							...
							<tr align="center" bgcolor="#F2FDFF">
								...
								<td align="left">
									${sessionScope.admininfo.username }
									<input type="hidden" name="users.username" style="width: 160px" id="username" value="${sessionScope.admininfo.username }" />
									<input type="hidden" name="users.userid" style="width: 160px" id="userid" value="${sessionScope.adminid }"/>
								</td>
							</tr>
							<tr align="center" bgcolor="#F2FDFF">
								<td width="20%" align="right">
