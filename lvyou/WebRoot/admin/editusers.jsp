...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	%><body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr valign="top">
				<td bgcolor="#FFFFFF">
					<s:form action="users/updateUsers.action" name="myform"
						...
						<table width="40%" border="0" align="center" cellpadding="4"
							...
							<tr align="center" bgcolor="#F2FDFF">
								...
								<td align="left">
									<input type="text" name="users.username" style="width: 160px" readonly="readonly"
										id="username" value="${users.username}" />
									<input type="hidden" name="users.password" style="width: 160px"
							...
							<tr align="center" bgcolor="#F2FDFF">
								...
								<td align="left">
									<input type="text" name="users.contact" style="width: 160px"
										id="contact" value="${users.contact}" />
								</td>
							</tr>
							<tr align="center" bgcolor="#F2FDFF">
								<td width="20%" align="right">
								...
								<td align="left">
									<input type="text" name="users.address" style="width: 160px"
										id="address" value="${users.address}" />
								</td>
							</tr>
							<tr align="center" bgcolor="#F2FDFF">
								<td width="20%" align="right">
