...
public class ArticleBusiness {
	...
	/** check * */
	public List<ArticleEntity> checkTitle(String name) {
		return this.articleDAO.queryByTitle(name);
	}

	/** check * */
	public List<ArticleEntity> checkContents(String name) {
		return this.articleDAO.queryByContents(name);
	}

	/** check * */
	public List<ArticleEntity> checkAddtime(String name) {
		return this.articleDAO.queryByAddtime(name);
	}

	/** check * */
	public List<ArticleEntity> checkByLikeTitle(String name) {
		return this.articleDAO.queryLikeByTitle(name);
	}

	/** check * */
	public List<ArticleEntity> checkByLikeContents(String name) {
		return this.articleDAO.queryLikeByContents(name);
	}

	/** check * */
	public List<ArticleEntity> checkByLikeAddtime(String name) {
		return this.articleDAO.queryLikeByAddtime(name);
	}

	/** checkId * */
	public ArticleEntity checkId(String id) {
