...
public class TopicBusiness {
	...
	/** check * */
	public List<TopicEntity> checkUsersid(String name) {
		return this.topicDAO.queryByUsersid(name);
	}

	/** check * */
	public List<TopicEntity> checkLinesid(String name) {
		return this.topicDAO.queryByLinesid(name);
	}

	/** check * */
	public List<TopicEntity> checkContents(String name) {
		return this.topicDAO.queryByContents(name);
	}

	/** check * */
	public List<TopicEntity> checkAddtime(String name) {
		return this.topicDAO.queryByAddtime(name);
	}

	/** check * */
	public List<TopicEntity> checkByLikeUsersid(String name) {
		return this.topicDAO.queryLikeByUsersid(name);
	}

	/** check * */
	public List<TopicEntity> checkByLikeLinesid(String name) {
		return this.topicDAO.queryLikeByLinesid(name);
	}

	/** check * */
	public List<TopicEntity> checkByLikeContents(String name) {
		return this.topicDAO.queryLikeByContents(name);
	}

	/** check * */
	public List<TopicEntity> checkByLikeAddtime(String name) {
		return this.topicDAO.queryLikeByAddtime(name);
	}

	/** checkId * */
	public TopicEntity checkId(String id) {
