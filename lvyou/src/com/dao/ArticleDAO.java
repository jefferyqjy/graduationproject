...
public class ArticleDAO extends HibernateDaoSupport {
	...
	public void delete(int id) {
		try {
			super.getHibernateTemplate().delete(
					getHibernateTemplate().get("com.entity.ArticleEntity", id));
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<ArticleEntity> queryByTitle(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From ArticleEntity where title = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<ArticleEntity> queryByContents(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From ArticleEntity where contents = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<ArticleEntity> queryByAddtime(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From ArticleEntity where addtime = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<ArticleEntity> queryLikeByTitle(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From ArticleEntity where title like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<ArticleEntity> queryLikeByContents(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From ArticleEntity where contents like ?",
					"%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	...
	public List<ArticleEntity> queryLikeByAddtime(String name) {
		try {
			return super.getHibernateTemplate()
					.find("From ArticleEntity where addtime like ?",
							"%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	...
	public ArticleEntity queryById(int articleid) {
		try {
			ArticleEntity article = (ArticleEntity) super
					.getHibernateTemplate().get("com.entity.ArticleEntity",
							articleid);
			return article;
		} catch (RuntimeException re) {
			throw re;
