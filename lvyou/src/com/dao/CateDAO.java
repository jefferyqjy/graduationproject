...
public class CateDAO extends HibernateDaoSupport {
	...
	public void delete(int id) {
		try {
			super.getHibernateTemplate().delete(
					getHibernateTemplate().get("com.entity.CateEntity", id));
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<CateEntity> queryByCatename(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From CateEntity where catename = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<CateEntity> queryLikeByCatename(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From CateEntity where catename like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public CateEntity queryById(int cateid) {
		try {
			CateEntity cate = (CateEntity) super.getHibernateTemplate().get(
					"com.entity.CateEntity", cateid);
			return cate;
		} catch (RuntimeException re) {
			throw re;
		}
