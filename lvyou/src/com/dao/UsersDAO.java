...
public class UsersDAO extends HibernateDaoSupport {
	...
	public void delete(int id) {
		try {
			super.getHibernateTemplate().delete(
					getHibernateTemplate().get("com.entity.UsersEntity", id));
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryByUsername(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where username = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryByPassword(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where password = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryByRealname(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where realname = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryBySex(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where sex = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryByBirthday(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where birthday = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryByContact(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where contact = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryByAddress(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where address = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	@SuppressWarnings("unchecked")
	public List<UsersEntity> queryByPowers(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where powers = ?", name);
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryLikeByUsername(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where username like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryLikeByPassword(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where password like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryLikeByRealname(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where realname like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryLikeBySex(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where sex like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryLikeByBirthday(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where birthday like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryLikeByContact(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where contact like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<UsersEntity> queryLikeByAddress(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where address like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	@SuppressWarnings("unchecked")
	public List<UsersEntity> queryLikeByPowers(String name) {
		try {
			return super.getHibernateTemplate().find(
					"From UsersEntity where powers like ?", "%" + name + "%");
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public UsersEntity queryById(int usersid) {
		try {
			UsersEntity users = (UsersEntity) super.getHibernateTemplate().get(
					"com.entity.UsersEntity", usersid);
			return users;
		} catch (RuntimeException re) {
			throw re;
		}
