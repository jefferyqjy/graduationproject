...
public class ComperTag extends TagSupport {
	...
	public int doStartTag() throws JspTagException {
		...
		Intro intro = author.getFind(cid);
...
//        	Author user = (Author)pageContext.getAttribute("user");
        	...
        	if(intro != null ){
        		out.println("<img width=\"100\" height=\"100\" src=\" "+intro.getUrl()+"\" />");
        		out.println("¥¥Ω®»À:"+intro.getName());
        	}
        } catch (Exception e) {   
