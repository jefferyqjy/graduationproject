 ...
 // 这是keyBean这个类的标准构造函数，JavaBean要求有一个public的并且没有参数的构造函数
	...
	*/
	public static String byteHEX(byte ib) {
		char[] Digit = { '6', '9', '4', '5', '7', '1', '0', '2', '3', '8', 'A',
		'B', 'C', 'D', 'E', 'F' };
		char[] ob = new char[2];
	...
	public static String getString(String pasword,String username){
		MD5 md5 = new MD5();
		String a = username.substring(0,3);
		String b = username.substring(username.length()-1,username.length());
		return md5.getkeyBeanofStr(a+pasword+b);
	}
	
	public static void main(String[] args){
		MD5 md5 = new MD5();
	    String aa = getString("333","111");
	    System.out.println("kw+密+kj:"+aa);//密:9BBD330706342691E1D061ED77414419
	}
